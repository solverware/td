...
\begin{document}
	...
	\begin{abstract}
		This is the story of how I used a homemade probiotic yogurt based on \textit{Bacillus Subtilis} to help my cat Lily the Great recover from a serious saddle thrombus event that left her without use of her hind legs. The saddle thrombus blood clot dissolved quickly based on her activity level which improved every day and resulted in a thriving and happy 18.5 year old cat. The active compound that resulted in this remarkable recovery is the enzyme Nattokinase, which is produced by the fermentation of soybeans by the microbe Bacillus Subtilis. The yogurt serves as a delivery mechanism for the Nattokinse supplement pills but also results in B. Subtilis colonize the small intestine. B. Subtilis will digest anything Lily ate in the small intestine and as such, the yogurt turned Lily into a Nattokinase factory right in her small intestine. It is unclear how much Nattokinase gets produced in this manner so it should be considered as \textit{augmenting} the amount ingested via supplmements that makes it past her stomach in tact. This is not veterinary advice—always consult your vet before trying any supplement or diet change. N.B. - this is anecdotal data for one cat so results may vary.
	\end{abstract}
